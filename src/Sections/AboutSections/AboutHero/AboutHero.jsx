...
import { GetQuotePopup } from "../../HomeSections/GetQuotePopup/GetQuotePopup";
...
import "../../HomeSections/HeroSection/HeroSection.css";
...
const AboutMainHero = () => {
  ...
  const mainHeadlineStyle = {
    ...styles.mainHeadline,
    fontSize: isMobile ? "clamp(26px, 6vw, 36px)" : "40px",
    textAlign: isMobile ? "center" : "left",
  };
  ...
  return (
    <motion.section style={sectionContainerStyle}>
      <div style={contentGridStyle}>
        ...
        >
          <motion.h1 style={mainHeadlineStyle} variants={itemVariants}>
            A TEAM OF THE HIGHEST RANKING WRITERS, EDITORS, AND PUBLISHERS IN THE BOOK INDUSTRY.
          </motion.h1>
