      ...
      <div style={contentGrid}>
        ...
        <motion.div style={heroTextContainer} variants={containerVariants} initial="hidden" animate="visible">
          <motion.h1 style={mainHeadline1} variants={itemVariants}>
            LAUNCH YOUR NON-FICTION WRITING SERVICES WITH OUR EXPERIENCED WRITERS
          </motion.h1>
          <motion.p style={subHeadline} variants={itemVariants}>
            Launch your non-fiction writing services with our experienced writers at Pegasus Writing. We offer expert writing solutions for books, articles, blogs, and more, ensuring your message is clear, engaging, and professionally crafted to captivate your audience.
          </motion.p>
          <motion.button
            style={{
              ...styles.ctaButton,
