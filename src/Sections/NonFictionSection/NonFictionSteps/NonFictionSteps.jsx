...
const nonfictionSteps = [
  {
    ...
    frontText:
      "Let us know the essence of your non-fiction story. Share your ideas, themes, and vision, and we’ll craft a tailored plan to bring your story to life.",
    backText:
  ...
  },
  {
    ...
    frontText:
      "Our expert editors meticulously polish your non-fiction manuscript, enhancing clarity, structure, and grammar, ensuring your book is ready for publication.",
    backText:
  ...
  },
  {
    id: 3,
    icon: Lightbulb,
    title: "Anticipate in your Non-Fiction Book",
    frontText:
      "We anticipate the readers' needs and expectations, ensuring your non-fiction book delivers valuable insights, engages the audience, and leaves a lasting impact.",
    backText:
  ...
  },
  {
    ...
    title: "Revision",
    frontText:
      "We provide comprehensive revision services, refining your non-fiction book at every level—conceptual, structural, and linguistic—to ensure coherence and seamless storytelling.",
    backText:
      "Our final revisions check for facts, formatting consistency, and final style details for publication-readiness.",
  },
];

const NonFictionStepsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="memoir-section">
      ...
      <h2 className={`memoir-heading ${isVisible ? "visible" : ""}`}>
        OUR STANDARD NON-FICTION WRITING PROCESS
      </h2>
      <div className="memoir-underline"></div>

      <div className="cards-grid">
        {nonfictionSteps.map((step, index) => {
...
export default NonFictionStepsSection;
