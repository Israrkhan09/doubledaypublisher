      ...
      <div style={contentGrid}>
        ...
        <motion.div style={heroTextContainer} variants={containerVariants} initial="hidden" animate="visible">
          ...
          <motion.p style={subHeadline} variants={itemVariants}>
            Discover the best memoir writing services at Double Day. Our expert writers craft captivating, personalized memoirs that preserve your life’s journey. Let us turn your memories into a beautifully written masterpiece you and future generations will cherish.
          </motion.p>
          <motion.button
            style={{
              ...styles.ctaButton,
