...
const memoirSteps = [
  {
    ...
    frontText:
      "Share your memoir ideas, themes, and life vision. We will craft a tailored outline to bring your story to life.",
    backText:
      "We gather your unique stories, experiences, and core messages, ensuring every detail of your life is captured.",
  },
  {
    id: 2,
    icon: PenTool,
    ...
    backText:
      "We structure your narrative into a compelling story arc, highlighting key life events and emotional milestones.",
  },
  {
    id: 3,
    icon: Lightbulb,
  ...
  },
  {
    ...
    frontText:
      "We perform a final conceptual and structural polish, preparing your memoir for formatting, cover design, and publication.",
    backText:
      "We handle formatting, cover designs, and platform submissions, successfully launching your memoir to the world.",
  },
];

const MemoirStepsSection = ({ title = "OUR 4-STEP MEMOIR WRITING PROCESS", steps = memoirSteps }) => {
